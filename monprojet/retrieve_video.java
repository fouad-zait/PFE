...
public class retrieve_video extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pdfref= FirebaseDatabase.getInstance().getReference("video");
        pdfref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                ListAdapterVideo adapter =new ListAdapterVideo(retrieve_video.this,pdfList);
