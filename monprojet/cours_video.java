...
public class cours_video extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cours_video);
    ...
    private void uploadepdffile(Uri data){
        ...
        StorageReference reference=storageReference.child("video/"+System.currentTimeMillis()+".avi");
        reference.putFile(data).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(cours_video.this,"cours envoyé",Toast.LENGTH_SHORT).show();
