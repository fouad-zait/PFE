...
public class cours_pdf extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cours_pdf);
    ...
    private void uploadepdffile(Uri data){
      ...
      StorageReference reference=storageReference.child("cours/"+System.currentTimeMillis()+".pdf");
        reference.putFile(data).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(cours_pdf.this,"cours envoyé",Toast.LENGTH_SHORT).show();
